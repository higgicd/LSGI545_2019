...
register_google(key = "AIzaSyCrGq4nEmbB6PLQ_L30nedpBdp2F1zhQBE")
...
```{r eval = FALSE}
# Set your key
key <- "AIzaSyCrGq4nEmbB6PLQ_L30nedpBdp2F1zhQBE"
```
...
The code below will geocode ALL the cycling flows for visualization. You will need your own Google API key to do this. *Don't run unless you have several hours to kill!* The tracks have already been geocoded below - skip to the next code chunk.
